...
<div style="margin: auto; width: fit-content;">
	<form id="formAuthentication" action="${contextPath }/admin/modifyNotice"
		...
		<div class="card-body" style="width: max-content; padding-top: 0">
			...
			<div class="mb-3">
				...
				<div class="col-md-10" style="width: 900px;">
					<input class="form-control" onkeyup="checkTitle(this)" type="text" value="${detailNotice.title }"
			...
			<div class="mb-3">
				...
				<div class="col-md-10" style="width: 900px;">
					<textarea id="content" name="content">${detailNotice.content }</textarea>
		...
		<input type="hidden" name="noticeId" value="${detailNotice.noticeId }">
	</form>
</div>
</body>
</html>