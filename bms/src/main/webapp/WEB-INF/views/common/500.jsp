        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h3 class="mb-4">문제가 발생한 경우 관리자에게 연락주세요.(admin@naver.com)</h3>
                    <a class="btn rounded-pill py-3 px-5" href="${contextPath }/" style=" box-shadow: none; color: white; background-color: black;">sim8log로 돌아가기</a>
                </div>
            </div>
        </div>
    </div>
