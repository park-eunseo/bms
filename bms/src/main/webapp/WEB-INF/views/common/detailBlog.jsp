...
>
  <head>
    ...
    <title>바근서 님의 블로그</title>

    <!-- 로고 -->
    <link rel="icon" type="image/x-icon" href="${contextPath }/resources/bootstrap/img/favicon/favicon.ico" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
		 ...
		 <!-- 사이드 메뉴 -->
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item active"> <!-- 본 카테고리 -->
            ...
            <!-- Layouts -->
            <li class="menu-item"> <!-- 카테고리 열면 class 변경함 -->
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Layouts</div>
              </a>

              <ul class="menu-sub"> <!-- 서브 카테고리 -->
                <li class="menu-item">
          ...
          <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
            ...
            <div class="navbar-nav align-items-center">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li>
                    <div class="avatar">
                      <img src="${contextPath }/resources/bootstrap/img/profile/1.png" class="w-px-40 h-auto rounded-circle" />
                    </div>
                </li> &ensp;
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  	<span class="align-middle">Admin 님</span>
                  </a>
